...
class TrainingAndLiveProjects extends Component{
     render(){
        return(
            ...
            ,backgroundSize: "cover", backgroundFit: "no repeat", backgroundPosition: "center center"}}>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12 col-sm-6">
                                <h1 style={{marginTop: "25px", color: "white",fontFamily: "Montserrat, sans-serif", fontWeight: "800" }}>Training And Live Projects</h1>
                            </div>
                        </div>
                    </div>
                ...
                <CarouselProvider naturalSlideWidth = { 100 }
                 ...
                 <div className="col-3"  >< h4 className="text-white"> Slide3 </h4></div></div></div> </Slide > 
                        ...
                        <div className="row">
                            <div className="col-12 col-md-5 offset-md-1">
                               <h3 style={{marginTop: "3vh", marginLeft: "3vw",fontFamily: "Montserrat, sans-serif", fontWeight: "800"}}>Training And IOT</h3> 
                 ...
                 at AnvayaEmpower we believe in providing innovative solutions to your career or technological problems.We broadly offer two kinds of services, as mentioned. </h4></p >
                            ...
                            <img src="https://www.flaticon.com/svg/static/icons/svg/3534/3534080.svg" alt="training and iot" className="img-fluid" style={{height: "23vh", width: "20vw", padding: "8px 2px 8px 2px",display: "flex", flexDirection: "row",
                        ...
                        <div className="row">
                            <div className="col-12 col-md-5 offset-md-6">
                               <h3 style={{marginTop: "8vh", marginLeft: "3vw",fontFamily: "Montserrat, sans-serif", fontWeight: "800"}}>Internship</h3> 
                        ...
                        <div className = "row">
                            <div className="col-12 col-md-3 col-sm-4 offset-md-1 order-sm-first">
                                <img src="https://www.flaticon.com/svg/static/icons/svg/1945/1945648.svg" alt="internship" className="img-fluid" style={{height: "23vh", width: "20vw", padding: "8px 2px 8px 2px",display: "flex", flexDirection: "row",
                                borderRadius :"40%", border: "2px solid",marginTop: "3vh", marginLeft: "3vw"}} />
                            </div>
...
export default TrainingAndLiveProjects;