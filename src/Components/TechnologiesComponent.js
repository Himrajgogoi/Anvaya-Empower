        ...
        >
          <Slider>
            <Slide
              ...
              style={{
                backgroundImage:
                  "url('https://source.unsplash.com/XJXWbfSo2f0/650X940')",
                backgroundSize: "cover",
                backgroundFit: "no repeat",
                backgroundPosition: "center center",
                minHeight: "30vh",
            ...
            <Slide
              ...
              style={{
                backgroundImage:
                  "url('https://source.unsplash.com/3_I4NVI9d1k/650X940')",
                backgroundSize: "cover",
                backgroundFit: "no repeat",
                backgroundPosition: "center center",
                minHeight: "30vh",
            ...
            >
              ...
              >
                <div className="row">
                  <div className="col-3">
                    <h4 className="text-white"> Slide2 </h4>
                  </div>
                </div>
              </div>
            </Slide>
            <Slide
              ...
              style={{
                backgroundImage:
                  "url('https://source.unsplash.com/SVmaaACzcJ8/650X940')",
                backgroundSize: "cover",
                backgroundFit: "no repeat",
                backgroundPosition: "center center",
                minHeight: "30vh",
            ...
            >
              ...
              >
                <div className="row">
                  <div className="col-3">
                    <h4 className="text-white"> Slide3</h4>
                  </div>
                </div>
              </div>
            </Slide>
          ...
          <div className="row">
            <div className="col-12 col-sm-6">
              ...
              >
                <CardHeader
                  ...
                  onMouseLeave={this.handleHover1}
                >
                  {" "}
                  <span className="fa fa-laptop fa-lg text-white"> </span>
                  <h3
                ...
                <Collapse isOpen={this.state.isCard1Open}>
                  <CardBody
                    style={{ borderRadius: "8px", backgroundColor: `#F57D39` }}
                  >
                    {" "}
                    <CardText style={{ color: `rgb(255, 255, 255)` }}>
                      ...
                      >
                        read more{" "}
                        <span className="fa fa-arrow-right d-inline"></span>
                      </Link>{" "}
                    </CardText>
                  </CardBody>
                </Collapse>
            ...
            <div className="col-12 col-sm-6">
              ...
              >
                ...
                >
                  {" "}
                  <span className="fa fa-shield fa-lg text-white"></span>
                  <h3
                    className="d-inline text-white"
                    style={{
                      fontFamily: "Montserrat, sans-serif",
          ...
          <div className="row">
            <div className="col-12 col-sm-6">
              ...
              >
                ...
                >
                  {" "}
                  <span className="fa fa-magic fa-lg text-white "></span>
                  <h3
                    className="d-inline text-white"
                    style={{
                      fontFamily: "Montserrat, sans-serif",
