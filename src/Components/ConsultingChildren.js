...
class ConsultingChildren extends Component{
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12 col-sm-6">
                                <h1 style={{marginTop: "25px", color: "white", fontFamily: "Montserrat, sans-serif", fontWeight: "800"}}>Consulting</h1>
                            </div>
                        </div>
                    </div>
                </div>
...
export default ConsultingChildren;