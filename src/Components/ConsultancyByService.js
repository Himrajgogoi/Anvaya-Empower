          ...
          <Slider>
                ...
                <div className="row">
                  <div className="col-6 col-md-3">
                    <Link to="/ConsultancyServices/branding">
                      ...
                      >
                        <CardImg
                          src="https://www.flaticon.com/svg/static/icons/svg/1253/1253370.svg"
                          className="img-fluid"
                          style={{ height: "30vh" }}
                        />
                  ...
                  <div className="col-6 col-md-3">
                    <Link to="/ConsultancyServices/marketing">
                      ...
                      >
                        <CardImg
                          src="https://www.flaticon.com/svg/static/icons/svg/1077/1077221.svg"
                          className="img-fluid"
                          style={{ height: "30vh" }}
                        />
                        <CardBody
                  ...
                  <div className="col-6 col-md-3">
                    <Link to="/ConsultancyServices/sales">
                      ...
                      >
                        <CardImg
                          src="https://www.flaticon.com/svg/static/icons/svg/1467/1467585.svg"
                          className="img-fluid"
                          style={{ height: "30vh" }}
                        />
                        <CardBody
                  ...
                  <div className="col-6 col-md-3">
                    <Link to="/ConsultancyServices/marketresearch">
                      ...
                      >
                        <CardImg
                          src="https://www.flaticon.com/svg/static/icons/svg/2909/2909902.svg"
                          className="img-fluid"
                          style={{ height: "30vh" }}
                        />
                        <CardBody
            ...
            <Slide index={1}>
              <div className="container">
                <div className="row">
                  <div className="col-6 col-md-3">
                    <Link to="/ConsultancyServices/businessadvisor">
                      <Card
                        style={slide2_style4}
                      ...
                      >
                        <CardImg
                          src="https://www.flaticon.com/svg/static/icons/svg/2906/2906151.svg"
                          className="img-fluid"
                          style={{ height: "30vh" }}
                        />
                        ...
                        >
                          ...
                          >
                            <b>
                              New business advisory and existing business
                              accleration support
                            </b>
                          </CardText>{" "}
                        </CardBody>
                  ...
                  <div className="col-6 col-md-3">
                    <Link to="/ConsultancyServices/humanresource">
                      ...
                      >
                        <CardImg
                          src="https://www.flaticon.com/svg/static/icons/svg/2942/2942304.svg"
                          className="img-fluid"
                          style={{ height: "30vh" }}
                        />
                        <CardBody
                  ...
                  <div className="col-6 col-md-3">
                    <Link to="/ConsultancyServices/csr">
                      ...
                      >
                        <CardImg
                          src="https://www.flaticon.com/svg/static/icons/svg/646/646503.svg"
                          className="img-fluid"
                          style={{ height: "30vh" }}
                        />
                  ...
                  <div className="col-6 col-md-3">
                    <Link to="/ConsultancyServices/digitalmarketing">
                      ...
                      >
                        <CardImg
                          src="https://www.flaticon.com/svg/static/icons/svg/902/902765.svg"
                          className="img-fluid"
                          style={{ height: "30vh" }}
                        />
                ...
                <div className="row">
                  <div className="col-6 col-md-3">
                    <Link to="/ConsultancyServices/operationalefficiency">
                      <Card
                        style={slide3_style4}
                        onMouseEnter={this.handleHoverSlide3_Card4}
                        onMouseLeave={this.handleHoverSlide3_Card4}
                      >
                        <CardImg
                          src="https://www.flaticon.com/svg/static/icons/svg/3456/3456433.svg"
                          className="img-fluid"
                          style={{ height: "30vh" }}
                        />
                        <CardBody
                        ...
                        >
                          ...
                          >
                            Operational Efficiency(Supply Chain) and Quality
                            Control
                          </CardText>{" "}
                        </CardBody>{" "}
                      </Card>{" "}
                  ...
                  <div className="col-6 col-md-3">
                    <Link to="/ConsultancyServices/regulatoryandgovernmentpolicy">
                      <Card
                        style={slide3_style1}
                        onMouseEnter={this.handleHoverSlide3_Card1}
                        onMouseLeave={this.handleHoverSlide3_Card1}
                      >
                        <CardImg
                          src="https://www.flaticon.com/svg/static/icons/svg/3530/3530560.svg"
                          className="img-fluid"
                          style={{ height: "30vh" }}
                        />
                        <CardBody
                        ...
                        >
                          ...
                          >
                            <b>Regulatory and Government Policy</b>
                          </CardText>{" "}
                        </CardBody>{" "}
                      </Card>{" "}
                    </Link>
                  ...
                  <div className="col-6 col-md-3">
                    <Link to="/ConsultancyServices/funding">
                      <Card
                        style={slide3_style2}
                        onMouseEnter={this.handleHoverSlide3_Card2}
                        onMouseLeave={this.handleHoverSlide3_Card2}
                      >
                        <CardImg
                          src="https://www.flaticon.com/svg/static/icons/svg/1355/1355162.svg"
                          className="img-fluid"
                          style={{ height: "30vh" }}
                        />
                        ...
                        >
                          ...
                          >
                            <b>Funding Compliance Assessment</b>
                          </CardText>{" "}
                        </CardBody>
                      </Card>{" "}
                    </Link>
