    ...
    return (
      <>
        <Switch>
          ...
          <Route path="/technologies/:id" component={TechnologyInfo} />

          <Route
            path="/ConsultancySectors/:id"
            component={ConsultancySectors}
          />
          <Route
            path="/ConsultancyServices/:id"
            component={ConsultancyService}
          />
          <Route path="/BlogChildren" component={BlogChildren} />

          <Route
            path="/OurServiceAndProduct"
            component={OurServiceAndProduct}
          />
          <Route
          ...
          />
          <Route
            path="/TrainingAndLiveProjects"
            component={TrainingAndLiveProjects}
          />
